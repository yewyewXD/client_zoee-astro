  ...
  return (
    <div className="HeroSection h-screen w-full relative">
      ...
      <div className="container text-white flex flex-col items-center justify-center h-full relative text-center">
        <div className="2xl:text-xl sm:text-lg mb-3" data-aos="fade-up">
          For People Who Want To Become The Best Version Of Themselves…
        </div>
        <h1
          className="2xl:text-6xl md:text-4xl text-3xl font-bold lg:w-7/12"
          data-aos="fade-up"
          data-aos-delay="150"
        >
        ...
        <div
          className="2xl:text-xl sm:text-lg md:mt-6 mt-4 font-semibold 2xl:w-5/12 lg:w-7/12 md:w-9/12 text-gray-100"
          data-aos="fade-up"
          data-aos-delay="300"
        >
        ...
        <div
          className="flex items-center lg:mt-10 mt-6"
          data-aos="fade-up"
          data-aos-delay="450"
        >
